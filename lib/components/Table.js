...
var Table = function Table(_ref) {
  ...
  var generateKey = function generateKey(column, index) {
    var property = column.property || 'noProperty';
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        columns.map(function (column, index) {
          return _react2.default.createElement(
            'th',
            { key: generateKey(column, index), style: styles.th },
            column.label
          );
        })
      )
  ...
  var renderRow = function renderRow(row, rowIndex) {
    return _react2.default.createElement(
      'tr',
      { key: rowIndex },
      columns.map(function (column, colIndex) {
        ...
        return _react2.default.createElement(
          'td',
          { key: generateKey(column, colIndex), style: styles.td },
          cell
        );
      })
    );
